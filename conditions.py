...
def condition_turn_end_listener(figure):
    ...
    if condition in tick_down_at_end: # shield does not tick down at end of turn by default
...
def shield_listener(figure, damage_taken):
...
def setup_condition_listeners(map):
    map.events.register("hero_turn_end", condition_turn_end_listener)
